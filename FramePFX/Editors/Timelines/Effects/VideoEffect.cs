...
namespace FramePFX.Editors.Timelines.Effects {
    public abstract class VideoEffect : BaseEffect {
        ...
        /// <summary>
        /// Called before a video clip's <see cref="VideoClip.PrepareRenderFrame"/> method.
        ...
        public virtual void PrePrepareFrame(PreRenderContext ctx, long frame) {

        }

        /// <summary>
        /// Called after a video clip's <see cref="VideoClip.PrepareRenderFrame"/> method.
        /// This method is called on the application main thread
        /// </summary>
        /// <param name="ctx">The pre-render context information</param>
        /// <param name="frame">The frame, relative to the clip, being rendered</param>
        public virtual void PostPrepareFrame(PreRenderContext ctx, long frame) {
